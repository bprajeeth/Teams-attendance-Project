...
def calc(sheet,sheet2,sheet1,wb2,root):
 r=sheet.max_row
 #c=sheet.max_column
 r2=sheet2.max_row
 ...
 frame=LabelFrame(root,bd=5)  # FOR CREATING FRAME FOR THE LABELS
 frame.pack()
 ...
 if(ct==0 or ct2==0):
  ...
  label1=Label(frame,text="ATTENDANCE SUCCESSFULLY CALCULATED for "+ai+"\n\nCheck class_list_IT_A.xlsx for details of compiled attendance",font=("Courier New",18),fg="green",pady=15)
  label1.pack()
  print("\n\n   *** ATTENDANCE SUCCESSFULLY CALCULATED *** ")
  print("\n    Check class_list_IT_A.xlsx for details of compiled attendance")

 else:
   label2=Label(frame,text="Attendance has already been compiled for "+ai+"\n\nPlease check class_list_IT_A.xlsx for the compiled details....",font=("Courier New",18),fg="blue",pady=15)
   label2.pack()
...
def main(filename):
 ...
 s=filename.name
 if(s[-4::1]=='.csv'):
  s=os.path.basename(filename.name)
  wb = openpyxl.Workbook()
  ws = wb.active
  with open(filename.name) as csv_file:
 ...
 calc(sheet,sheet2,sheet1,wb2,root)
 
def open_file():
    filename=fd.askopenfile(filetypes=[("file types","*.xlsx .csv")])
    print("root.name = ",filename)
    main(filename)
    
label=Label(root,text="WELCOME TO PRAJEETH'S ATTENDANCE CALCULATOR", font=("Comic Sans MS",30),fg="black",pady=10)
label.pack()  
lbl=Label(root,text ="\n\n\n\nClick here to select file",font=("Times New Roman",20),fg="grey",pady=10)
lbl.pack()
image = Image.open('file_icon.jpeg')
#Resize the Image
image = image.resize((30,30),Image.ANTIALIAS)
#Convert the image to PhotoImage
img= ImageTk.PhotoImage(image)
btn = Button(root, text =' Select File ',font=("Times New Roman",20),bg="light blue",fg="black",activebackground="grey",image=img,compound=LEFT,bd=6,command = lambda:open_file())
...
root.mainloop()
# text ='Select File',font=("Times New Roman",20),bg="light blue",fg="blue",activebackground="grey",height = 2, width = 10,bd=5

#ft=str(input("enter the end time of class in hh:mm format : "))
#h4,m4=ft.split(":")
#d_org={"B PRAJEETH":205002062} 
